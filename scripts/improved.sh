...
python M1M3_NASTRAN.py --M1ptt 6 --M3ptt 0 --indir $NASTRAN_DIR $OUT_DIR/M1M3_improved.pkl
python M1M3_decompose_sag.py --input $OUT_DIR/M1M3_improved.pkl $OUT_DIR/M1M3_decomposition_improved.pkl
python M1M3_format_for_batoid.py --input $OUT_DIR/M1M3_decomposition_improved.pkl --outdir $OUT_DIR --nkeep 30


python M2_NASTRAN.py --M2ptt 6 --indir $NASTRAN_DIR $OUT_DIR/M2_improved.pkl
python M2_decompose_sag.py --input $OUT_DIR/M2_improved.pkl $OUT_DIR/M2_decomposition_improved.pkl
