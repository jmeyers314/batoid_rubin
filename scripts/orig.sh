...
python M1M3_decompose_sag.py --input $M1M3_ML_DIR/data/myUdn3norm_156.mat $OUT_DIR/M1M3_decomposition_orig.pkl
python M1M3_format_for_batoid.py --input $OUT_DIR/M1M3_decomposition_orig.pkl --outdir $OUT_DIR --nkeep 20 --swap "[19,26]"

python M2_decompose_sag.py --input $M2_FEA_DIR/data/M2_Udn3norm.mat $OUT_DIR/M2_decomposition_orig.pkl
python M2_format_for_batoid.py --input $OUT_DIR/M2_decomposition_orig.pkl --outdir $OUT_DIR --nkeep 20 --swap "[17,18,19,25,26,27]"
